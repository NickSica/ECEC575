...
Technology	{
		name				= "TSMC N28 SP9M6X1Z1UUTRDL HVH TC"
		date				= "Aug 19 2019"
		dielectric			= 3.45e-05
		unitTimeName			= "ns"
		timePrecision			= 1000
...
Layer		"VIA1" {
		...
		minCutsTblSize			= 7
		minCutsTbl			= (1,Vrect,-1.000,0.181,-1.000000,-1.000,
						   2,Vrect,-1.000,0.441,-1.000000,-1.000,
						   1,Vrect,0.181,-1.000,-1.000000,-1.000,
						   1,Vrect,0.181,-1.000,-1.000000,1.805,
						   2,Vrect,0.441,-1.000,-1.000000,-1.000,
						   1,Vrect,1.001,-1.000,-1.000000,4.155,
						   1,Vrect,1.501,-1.000,-1.000000,10.155)
...
Layer		"VIA7" {
		...
		fatTblExtensionCheckCrossingCut	= 1
		minCutsTblSize			= 3
		minCutsTbl			= (2,Vzsq,-1.000,1.801,-1.000000,-1.000,
						   2,Vzsq,1.801,-1.000,-1.000000,-1.000,
						   2,Vzsq,3.001,-1.000,-1.000000,5.005)
		enclosedCutNumNeighbor		= 3
...
Layer		"VIA8" {
		...
		fatTblExtensionCheckCrossingCut	= 1
		minCutsTblSize			= 3
		minCutsTbl			= (2,Vusq,-1.000,2.001,-1.000000,-1.000,
						   2,Vusq,2.001,-1.000,-1.000000,-1.000,
						   2,Vusq,3.001,-1.000,-1.000000,5.005)
		enclosedCutNumNeighbor		= 3
		enclosedCutNeighborRange	= 0.56
		enclosedCutToNeighborMinSpacing	= 0.54
		cutTblSize			= 1
